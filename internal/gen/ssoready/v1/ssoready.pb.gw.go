...
func request_SSOReadyService_RedeemSAMLAccessToken_0(ctx context.Context, marshaler runtime.Marshaler, client SSOReadyServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RedeemSAMLAccessTokenRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.RedeemSAMLAccessToken(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_SSOReadyService_RedeemSAMLAccessToken_0(ctx context.Context, marshaler runtime.Marshaler, server SSOReadyServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RedeemSAMLAccessTokenRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RedeemSAMLAccessToken(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterSSOReadyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SSOReadyServiceServer) error {
	...
	mux.Handle("POST", pattern_SSOReadyService_RedeemSAMLAccessToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ssoready.v1.SSOReadyService/RedeemSAMLAccessToken", runtime.WithHTTPPathPattern("/v1/saml/redeem"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SSOReadyService_RedeemSAMLAccessToken_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_SSOReadyService_RedeemSAMLAccessToken_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// "SSOReadyServiceClient" to call the correct interceptors.
func RegisterSSOReadyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SSOReadyServiceClient) error {
	...
	mux.Handle("POST", pattern_SSOReadyService_RedeemSAMLAccessToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ssoready.v1.SSOReadyService/RedeemSAMLAccessToken", runtime.WithHTTPPathPattern("/v1/saml/redeem"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SSOReadyService_RedeemSAMLAccessToken_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_SSOReadyService_RedeemSAMLAccessToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "saml", "redeem"}, ""))
)

var (
	forward_SSOReadyService_GetSAMLRedirectURL_0 = runtime.ForwardResponseMessage

	forward_SSOReadyService_RedeemSAMLAccessToken_0 = runtime.ForwardResponseMessage
)
