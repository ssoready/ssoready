...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xae, 0x07, 0x0a, 0x0f, 0x53,
	0x53, 0x4f, 0x52, 0x65, 0x61, 0x64, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x8a,
	0x01, 0x0a, 0x15, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x53, 0x41, 0x4d, 0x4c, 0x41, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x29, 0x2e, 0x73, 0x73, 0x6f, 0x72, 0x65,
	0x61, 0x64, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x53, 0x41, 0x4d,
	0x4c, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x73, 0x73, 0x6f, 0x72, 0x65, 0x61, 0x64, 0x79, 0x2e, 0x76,
	...
	0x6e, 0x74, 0x12, 0x62, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69,
	...
	0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x68, 0x0a, 0x13, 0x4c, 0x69, 0x73,
	...
	0x4c, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xaf, 0x01, 0x0a, 0x0f,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	nil,                                   // 20: ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	20, // 0: ssoready.v1.RedeemSAMLAccessTokenResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
	...
	4,  // 5: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:input_type -> ssoready.v1.RedeemSAMLAccessTokenRequest
	6,  // 6: ssoready.v1.SSOReadyService.SignIn:input_type -> ssoready.v1.SignInRequest
	8,  // 7: ssoready.v1.SSOReadyService.Whoami:input_type -> ssoready.v1.WhoamiRequest
	10, // 8: ssoready.v1.SSOReadyService.ListEnvironments:input_type -> ssoready.v1.ListEnvironmentsRequest
	12, // 9: ssoready.v1.SSOReadyService.GetEnvironment:input_type -> ssoready.v1.GetEnvironmentRequest
	13, // 10: ssoready.v1.SSOReadyService.ListOrganizations:input_type -> ssoready.v1.ListOrganizationsRequest
	15, // 11: ssoready.v1.SSOReadyService.GetOrganization:input_type -> ssoready.v1.GetOrganizationRequest
	16, // 12: ssoready.v1.SSOReadyService.ListSAMLConnections:input_type -> ssoready.v1.ListSAMLConnectionsRequest
	18, // 13: ssoready.v1.SSOReadyService.GetSAMLConnection:input_type -> ssoready.v1.GetSAMLConnectionRequest
	19, // 14: ssoready.v1.SSOReadyService.CreateSAMLConnection:input_type -> ssoready.v1.CreateSAMLConnectionRequest
	5,  // 15: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:output_type -> ssoready.v1.RedeemSAMLAccessTokenResponse
	7,  // 16: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	9,  // 17: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	11, // 18: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	1,  // 19: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	14, // 20: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	2,  // 21: ssoready.v1.SSOReadyService.GetOrganization:output_type -> ssoready.v1.Organization
	17, // 22: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
	3,  // 23: ssoready.v1.SSOReadyService.GetSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	3,  // 24: ssoready.v1.SSOReadyService.CreateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
