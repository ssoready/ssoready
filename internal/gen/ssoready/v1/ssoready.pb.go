...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x6c, 0x32, 0xa4, 0x02, 0x0a, 0x0f, 0x53, 0x53, 0x4f, 0x52, 0x65, 0x61, 0x64, 0x79, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x8a, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d,
	0x53, 0x41, 0x4d, 0x4c, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
	...
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x73, 0x73, 0x6f,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	nil,                                   // 10: ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	10, // 0: ssoready.v1.RedeemSAMLAccessTokenResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
	...
	8,  // 3: ssoready.v1.SSOReadyService.Whoami:input_type -> ssoready.v1.WhoamiRequest
	5,  // 4: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:output_type -> ssoready.v1.RedeemSAMLAccessTokenResponse
	7,  // 5: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	9,  // 6: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
