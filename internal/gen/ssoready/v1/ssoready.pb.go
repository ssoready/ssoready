...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x49, 0x64, 0x2a, 0x91, 0x01, 0x0a, 0x0e, 0x53, 0x41, 0x4d, 0x4c, 0x46, 0x6c, 0x6f,
	...
	0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10, 0x03, 0x32, 0xd3, 0x18, 0x0a, 0x0f, 0x53, 0x53, 0x4f,
	...
	0x2f, 0x73, 0x61, 0x6d, 0x6c, 0x2f, 0x72, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x12, 0x46, 0x0a, 0x0b,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_ssoready_v1_ssoready_proto_goTypes = []any{
	...
	nil,                                           // 56: ssoready.v1.SAMLFlow.AttributesEntry
	nil,                                           // 57: ssoready.v1.RedeemSAMLAccessCodeResponse.AttributesEntry
...
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	...
	58, // 1: ssoready.v1.SAMLFlow.unsigned_assertion:type_name -> google.protobuf.Empty
	56, // 2: ssoready.v1.SAMLFlow.attributes:type_name -> ssoready.v1.SAMLFlow.AttributesEntry
	59, // 3: ssoready.v1.SAMLFlow.create_time:type_name -> google.protobuf.Timestamp
	59, // 4: ssoready.v1.SAMLFlow.update_time:type_name -> google.protobuf.Timestamp
	59, // 5: ssoready.v1.SAMLFlow.get_redirect_time:type_name -> google.protobuf.Timestamp
	59, // 6: ssoready.v1.SAMLFlow.initiate_time:type_name -> google.protobuf.Timestamp
	59, // 7: ssoready.v1.SAMLFlow.receive_assertion_time:type_name -> google.protobuf.Timestamp
	59, // 8: ssoready.v1.SAMLFlow.redeem_time:type_name -> google.protobuf.Timestamp
	57, // 9: ssoready.v1.RedeemSAMLAccessCodeResponse.attributes:type_name -> ssoready.v1.RedeemSAMLAccessCodeResponse.AttributesEntry
	...
	9,  // 58: ssoready.v1.SSOReadyService.GetSAMLRedirectURL:output_type -> ssoready.v1.GetSAMLRedirectURLResponse
	11, // 59: ssoready.v1.SSOReadyService.RedeemSAMLAccessCode:output_type -> ssoready.v1.RedeemSAMLAccessCodeResponse
	58, // 60: ssoready.v1.SSOReadyService.VerifyEmail:output_type -> google.protobuf.Empty
	14, // 61: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	16, // 62: ssoready.v1.SSOReadyService.SignOut:output_type -> ssoready.v1.SignOutResponse
	18, // 63: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	20, // 64: ssoready.v1.SSOReadyService.GetOnboardingState:output_type -> ssoready.v1.GetOnboardingStateResponse
	58, // 65: ssoready.v1.SSOReadyService.UpdateOnboardingState:output_type -> google.protobuf.Empty
	9,  // 66: ssoready.v1.SSOReadyService.OnboardingGetSAMLRedirectURL:output_type -> ssoready.v1.GetSAMLRedirectURLResponse
	11, // 67: ssoready.v1.SSOReadyService.OnboardingRedeemSAMLAccessCode:output_type -> ssoready.v1.RedeemSAMLAccessCodeResponse
	25, // 68: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	2,  // 69: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	2,  // 70: ssoready.v1.SSOReadyService.CreateEnvironment:output_type -> ssoready.v1.Environment
	2,  // 71: ssoready.v1.SSOReadyService.UpdateEnvironment:output_type -> ssoready.v1.Environment
	30, // 72: ssoready.v1.SSOReadyService.ListAPIKeys:output_type -> ssoready.v1.ListAPIKeysResponse
	3,  // 73: ssoready.v1.SSOReadyService.GetAPIKey:output_type -> ssoready.v1.APIKey
	3,  // 74: ssoready.v1.SSOReadyService.CreateAPIKey:output_type -> ssoready.v1.APIKey
	58, // 75: ssoready.v1.SSOReadyService.DeleteAPIKey:output_type -> google.protobuf.Empty
	35, // 76: ssoready.v1.SSOReadyService.ListSAMLOAuthClients:output_type -> ssoready.v1.ListSAMLOAuthClientsResponse
	4,  // 77: ssoready.v1.SSOReadyService.GetSAMLOAuthClient:output_type -> ssoready.v1.SAMLOAuthClient
	4,  // 78: ssoready.v1.SSOReadyService.CreateSAMLOAuthClient:output_type -> ssoready.v1.SAMLOAuthClient
	58, // 79: ssoready.v1.SSOReadyService.DeleteSAMLOAuthClient:output_type -> google.protobuf.Empty
	40, // 80: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	5,  // 81: ssoready.v1.SSOReadyService.GetOrganization:output_type -> ssoready.v1.Organization
	5,  // 82: ssoready.v1.SSOReadyService.CreateOrganization:output_type -> ssoready.v1.Organization
	5,  // 83: ssoready.v1.SSOReadyService.UpdateOrganization:output_type -> ssoready.v1.Organization
	45, // 84: ssoready.v1.SSOReadyService.CreateAdminSetupURL:output_type -> ssoready.v1.CreateAdminSetupURLResponse
	47, // 85: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
	6,  // 86: ssoready.v1.SSOReadyService.GetSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	6,  // 87: ssoready.v1.SSOReadyService.CreateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	6,  // 88: ssoready.v1.SSOReadyService.UpdateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	52, // 89: ssoready.v1.SSOReadyService.ListSAMLFlows:output_type -> ssoready.v1.ListSAMLFlowsResponse
	7,  // 90: ssoready.v1.SSOReadyService.GetSAMLFlow:output_type -> ssoready.v1.SAMLFlow
	55, // 91: ssoready.v1.SSOReadyService.ParseSAMLMetadata:output_type -> ssoready.v1.ParseSAMLMetadataResponse
