...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x0d, 0x6e, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x85,
	0x03, 0x0a, 0x0f, 0x53, 0x53, 0x4f, 0x52, 0x65, 0x61, 0x64, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x8a, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x53, 0x41, 0x4d,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	nil,                                   // 12: ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	12, // 0: ssoready.v1.RedeemSAMLAccessTokenResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
	1,  // 1: ssoready.v1.ListEnvironmentsResponse.environments:type_name -> ssoready.v1.Environment
	4,  // 2: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:input_type -> ssoready.v1.RedeemSAMLAccessTokenRequest
	6,  // 3: ssoready.v1.SSOReadyService.SignIn:input_type -> ssoready.v1.SignInRequest
	8,  // 4: ssoready.v1.SSOReadyService.Whoami:input_type -> ssoready.v1.WhoamiRequest
	10, // 5: ssoready.v1.SSOReadyService.ListEnvironments:input_type -> ssoready.v1.ListEnvironmentsRequest
	5,  // 6: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:output_type -> ssoready.v1.RedeemSAMLAccessTokenResponse
	7,  // 7: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	9,  // 8: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	11, // 9: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
