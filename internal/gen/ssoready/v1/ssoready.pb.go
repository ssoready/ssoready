...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xe8, 0x09, 0x0a, 0x0f,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	nil,                                  // 26: ssoready.v1.SAMLFlow.SubjectIdpAttributesEntry
	nil,                                  // 27: ssoready.v1.RedeemSAMLAccessCodeResponse.SubjectIdpAttributesEntry
	(*timestamppb.Timestamp)(nil),        // 28: google.protobuf.Timestamp
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	26, // 0: ssoready.v1.SAMLFlow.subject_idp_attributes:type_name -> ssoready.v1.SAMLFlow.SubjectIdpAttributesEntry
	28, // 1: ssoready.v1.SAMLFlow.create_time:type_name -> google.protobuf.Timestamp
	28, // 2: ssoready.v1.SAMLFlow.update_time:type_name -> google.protobuf.Timestamp
	28, // 3: ssoready.v1.SAMLFlow.get_redirect_time:type_name -> google.protobuf.Timestamp
	28, // 4: ssoready.v1.SAMLFlow.initiate_time:type_name -> google.protobuf.Timestamp
	28, // 5: ssoready.v1.SAMLFlow.receive_assertion_time:type_name -> google.protobuf.Timestamp
	28, // 6: ssoready.v1.SAMLFlow.redeem_time:type_name -> google.protobuf.Timestamp
	27, // 7: ssoready.v1.RedeemSAMLAccessCodeResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessCodeResponse.SubjectIdpAttributesEntry
	...
	6,  // 27: ssoready.v1.SSOReadyService.GetSAMLRedirectURL:output_type -> ssoready.v1.GetSAMLRedirectURLResponse
	8,  // 28: ssoready.v1.SSOReadyService.RedeemSAMLAccessCode:output_type -> ssoready.v1.RedeemSAMLAccessCodeResponse
	10, // 29: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	12, // 30: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	14, // 31: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	1,  // 32: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	17, // 33: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	2,  // 34: ssoready.v1.SSOReadyService.GetOrganization:output_type -> ssoready.v1.Organization
	20, // 35: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
	3,  // 36: ssoready.v1.SSOReadyService.GetSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	3,  // 37: ssoready.v1.SSOReadyService.CreateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	3,  // 38: ssoready.v1.SSOReadyService.UpdateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	25, // 39: ssoready.v1.SSOReadyService.ListSAMLFlows:output_type -> ssoready.v1.ListSAMLFlowsResponse
