...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xcf, 0x06, 0x0a, 0x0f, 0x53, 0x53, 0x4f, 0x52, 0x65, 0x61,
	...
	0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xaf, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	nil,                                   // 19: ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	19, // 0: ssoready.v1.RedeemSAMLAccessTokenResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
	...
	18, // 12: ssoready.v1.SSOReadyService.GetSAMLConnection:input_type -> ssoready.v1.GetSAMLConnectionRequest
	5,  // 13: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:output_type -> ssoready.v1.RedeemSAMLAccessTokenResponse
	7,  // 14: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	9,  // 15: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	11, // 16: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	1,  // 17: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	14, // 18: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	2,  // 19: ssoready.v1.SSOReadyService.GetOrganization:output_type -> ssoready.v1.Organization
	17, // 20: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
	3,  // 21: ssoready.v1.SSOReadyService.GetSAMLConnection:output_type -> ssoready.v1.SAMLConnection
