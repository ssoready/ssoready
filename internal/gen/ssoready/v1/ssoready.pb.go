...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x64, 0x0a, 0x1a, 0x4c, 0x69, 0x73,
	...
	0xa3, 0x05, 0x0a, 0x0f, 0x53, 0x53, 0x4f, 0x52, 0x65, 0x61, 0x64, 0x79, 0x53, 0x65, 0x72, 0x76,
	...
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a, 0x13, 0x4c,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	(*ListSAMLConnectionsRequest)(nil),    // 15: ssoready.v1.ListSAMLConnectionsRequest
	(*ListSAMLConnectionsResponse)(nil),   // 16: ssoready.v1.ListSAMLConnectionsResponse
	nil,                                   // 17: ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	17, // 0: ssoready.v1.RedeemSAMLAccessTokenResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessTokenResponse.SubjectIdpAttributesEntry
	...
	15, // 10: ssoready.v1.SSOReadyService.ListSAMLConnections:input_type -> ssoready.v1.ListSAMLConnectionsRequest
	5,  // 11: ssoready.v1.SSOReadyService.RedeemSAMLAccessToken:output_type -> ssoready.v1.RedeemSAMLAccessTokenResponse
	7,  // 12: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	9,  // 13: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	11, // 14: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	1,  // 15: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	14, // 16: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	16, // 17: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
