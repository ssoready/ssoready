...
var file_ssoready_v1_ssoready_proto_rawDesc = []byte{
	...
	0x41, 0x63, 0x73, 0x55, 0x72, 0x6c, 0x22, 0x5f, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x53, 0x41, 0x4d,
	...
	0x63, 0x65, 0x73, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x92, 0x03, 0x0a, 0x1c, 0x52, 0x65, 0x64,
	...
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x6f, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x25, 0x0a,
	...
	0x6e, 0x74, 0x49, 0x64, 0x1a, 0x47, 0x0a, 0x19, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49,
	...
	0x0d, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b,
	0x0a, 0x11, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x35, 0x0a, 0x0e, 0x53,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x64, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x53,
	...
	0x69, 0x6f, 0x6e, 0x32, 0x90, 0x09, 0x0a, 0x0f, 0x53, 0x53, 0x4f, 0x52, 0x65, 0x61, 0x64, 0x79,
	...
	0x76, 0x31, 0x2e, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x62,
	...
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xaf, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x73,
...
var file_ssoready_v1_ssoready_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_ssoready_v1_ssoready_proto_goTypes = []interface{}{
	...
	(*GetSAMLRedirectURLRequest)(nil),    // 4: ssoready.v1.GetSAMLRedirectURLRequest
	(*GetSAMLRedirectURLResponse)(nil),   // 5: ssoready.v1.GetSAMLRedirectURLResponse
	(*RedeemSAMLAccessCodeRequest)(nil),  // 6: ssoready.v1.RedeemSAMLAccessCodeRequest
	(*RedeemSAMLAccessCodeResponse)(nil), // 7: ssoready.v1.RedeemSAMLAccessCodeResponse
	(*SignInRequest)(nil),                // 8: ssoready.v1.SignInRequest
	(*SignInResponse)(nil),               // 9: ssoready.v1.SignInResponse
	(*WhoamiRequest)(nil),                // 10: ssoready.v1.WhoamiRequest
	(*WhoamiResponse)(nil),               // 11: ssoready.v1.WhoamiResponse
	(*ListEnvironmentsRequest)(nil),      // 12: ssoready.v1.ListEnvironmentsRequest
	(*ListEnvironmentsResponse)(nil),     // 13: ssoready.v1.ListEnvironmentsResponse
	(*GetEnvironmentRequest)(nil),        // 14: ssoready.v1.GetEnvironmentRequest
	(*ListOrganizationsRequest)(nil),     // 15: ssoready.v1.ListOrganizationsRequest
	(*ListOrganizationsResponse)(nil),    // 16: ssoready.v1.ListOrganizationsResponse
	(*GetOrganizationRequest)(nil),       // 17: ssoready.v1.GetOrganizationRequest
	(*ListSAMLConnectionsRequest)(nil),   // 18: ssoready.v1.ListSAMLConnectionsRequest
	(*ListSAMLConnectionsResponse)(nil),  // 19: ssoready.v1.ListSAMLConnectionsResponse
	(*GetSAMLConnectionRequest)(nil),     // 20: ssoready.v1.GetSAMLConnectionRequest
	(*CreateSAMLConnectionRequest)(nil),  // 21: ssoready.v1.CreateSAMLConnectionRequest
	(*UpdateSAMLConnectionRequest)(nil),  // 22: ssoready.v1.UpdateSAMLConnectionRequest
	nil,                                  // 23: ssoready.v1.RedeemSAMLAccessCodeResponse.SubjectIdpAttributesEntry
}
var file_ssoready_v1_ssoready_proto_depIdxs = []int32{
	23, // 0: ssoready.v1.RedeemSAMLAccessCodeResponse.subject_idp_attributes:type_name -> ssoready.v1.RedeemSAMLAccessCodeResponse.SubjectIdpAttributesEntry
	...
	3,  // 4: ssoready.v1.CreateSAMLConnectionRequest.saml_connection:type_name -> ssoready.v1.SAMLConnection
	3,  // 5: ssoready.v1.UpdateSAMLConnectionRequest.saml_connection:type_name -> ssoready.v1.SAMLConnection
	4,  // 6: ssoready.v1.SSOReadyService.GetSAMLRedirectURL:input_type -> ssoready.v1.GetSAMLRedirectURLRequest
	6,  // 7: ssoready.v1.SSOReadyService.RedeemSAMLAccessCode:input_type -> ssoready.v1.RedeemSAMLAccessCodeRequest
	8,  // 8: ssoready.v1.SSOReadyService.SignIn:input_type -> ssoready.v1.SignInRequest
	10, // 9: ssoready.v1.SSOReadyService.Whoami:input_type -> ssoready.v1.WhoamiRequest
	12, // 10: ssoready.v1.SSOReadyService.ListEnvironments:input_type -> ssoready.v1.ListEnvironmentsRequest
	14, // 11: ssoready.v1.SSOReadyService.GetEnvironment:input_type -> ssoready.v1.GetEnvironmentRequest
	15, // 12: ssoready.v1.SSOReadyService.ListOrganizations:input_type -> ssoready.v1.ListOrganizationsRequest
	17, // 13: ssoready.v1.SSOReadyService.GetOrganization:input_type -> ssoready.v1.GetOrganizationRequest
	18, // 14: ssoready.v1.SSOReadyService.ListSAMLConnections:input_type -> ssoready.v1.ListSAMLConnectionsRequest
	20, // 15: ssoready.v1.SSOReadyService.GetSAMLConnection:input_type -> ssoready.v1.GetSAMLConnectionRequest
	21, // 16: ssoready.v1.SSOReadyService.CreateSAMLConnection:input_type -> ssoready.v1.CreateSAMLConnectionRequest
	22, // 17: ssoready.v1.SSOReadyService.UpdateSAMLConnection:input_type -> ssoready.v1.UpdateSAMLConnectionRequest
	5,  // 18: ssoready.v1.SSOReadyService.GetSAMLRedirectURL:output_type -> ssoready.v1.GetSAMLRedirectURLResponse
	7,  // 19: ssoready.v1.SSOReadyService.RedeemSAMLAccessCode:output_type -> ssoready.v1.RedeemSAMLAccessCodeResponse
	9,  // 20: ssoready.v1.SSOReadyService.SignIn:output_type -> ssoready.v1.SignInResponse
	11, // 21: ssoready.v1.SSOReadyService.Whoami:output_type -> ssoready.v1.WhoamiResponse
	13, // 22: ssoready.v1.SSOReadyService.ListEnvironments:output_type -> ssoready.v1.ListEnvironmentsResponse
	1,  // 23: ssoready.v1.SSOReadyService.GetEnvironment:output_type -> ssoready.v1.Environment
	16, // 24: ssoready.v1.SSOReadyService.ListOrganizations:output_type -> ssoready.v1.ListOrganizationsResponse
	2,  // 25: ssoready.v1.SSOReadyService.GetOrganization:output_type -> ssoready.v1.Organization
	19, // 26: ssoready.v1.SSOReadyService.ListSAMLConnections:output_type -> ssoready.v1.ListSAMLConnectionsResponse
	3,  // 27: ssoready.v1.SSOReadyService.GetSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	3,  // 28: ssoready.v1.SSOReadyService.CreateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
	3,  // 29: ssoready.v1.SSOReadyService.UpdateSAMLConnection:output_type -> ssoready.v1.SAMLConnection
